...
public class HibernateDataAccess implements DataAccessInterface {
	...
	public void initializeDB(){
		...
		try {
			...
			q1=ev1.addQuestion("�Qui va a ganar el partido?",1);
			q2=ev1.addQuestion("�Quien va a meter el primer gol?",2);
			//q3=ev14.addQuestion("¿Quién ganará el partido?",1);
			//q4=ev14.addQuestion("¿Cuántos goles se marcarán?",2);
